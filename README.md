...
A novel building age estimation model based on remote sensing data. Our paper is under reviewed on ISPRS. It's my first paper reviewed on ISPRS. Good luck to me!!
